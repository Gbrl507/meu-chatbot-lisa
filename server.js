...
// ================== 2. CREDENCIAIS ==================
const GROQ_API_KEY = process.env.GROQ_API_KEY || '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';
...
app.post('/chat', async (req, res) => {
    ...
    try {
        ...
        const systemPrompt = promptComposer({ 
            userId, memory: userMemory[userId], 
